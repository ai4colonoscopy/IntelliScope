...
<div align="center">
    <p align="center">
        ...
        🤖 <b>ColonGPT</b> (🔗 <a href="https://drive.google.com/drive/folders/1zMQDtazttfyW_oz5Utf2pbwvNVAitoRh?usp=sharing">Google Drive</a>, 🤗 <a href="https://huggingface.co/ai4colonoscopy/ColonGPT-v1">Huggingface</a>)
    </p>
</div>
...
- 💥 <u>Multimodal AI Initiatives</u> ➡️ ***"We advocate three initiatives to embrace the coming multimodal era in colonoscopy."***
   ...
   - 🤖 **ColonGPT.** We develop a domain-specific mutlimodal language model to assist endoscopists through interactive dialogues. To ensure reproducibilty for average community users, we implement ColonGPT in a resource-friendly way, including three core designs: a 0.4B-parameter visual encoder 🤗 [SigLIP-SO](https://huggingface.co/google/siglip-so400m-patch14-384) from Google, a 1.3B-parameter lightweight language model 🤗 [Phi1.5](https://huggingface.co/microsoft/phi-1_5) from Microsoft, and a multigranulinarity adapater for token reducing *from 100% to only 33.74% but not compromise to performance*. (🔗 [Hyperlink](https://github.com/ai4colonoscopy/IntelliScope?tab=readme-ov-file#-colongpt-a-colonoscopy-specific-multimodal-language-model))
   - 💯 **Multimodal Benchmark.** We contribute a multimodal benchmark, including eight general-purpose models and two designed for medical purposes, across four colonoscopy tasks to enable fair and rapid comparisons going forward. (🔗 [Hyperlink](https://github.com/ai4colonoscopy/IntelliScope?tab=readme-ov-file#-multimodal-benchmark))
