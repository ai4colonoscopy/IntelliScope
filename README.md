...
- *[Dec/09/2025]* 🔥🔥🔥 Thrilled to announce the largest multimodal colonoscopy dataset (1.1M+ VQA entries), along with reasoning-centric solutions: ColonReason dataset and the first reasoning-based model, ColonR1. Project is here: https://github.com/ai4colonoscopy/Colon-X?tab=readme-ov-file
